...
#include "Exporter/ParticleExporter_JSON.h"   // add this include
...
void SimulatorBase::createExporters()
{
	...
	addParticleExporter("enableJSONExport", "Particle JSON Exporter", "Enable/disable JSON export.", new ParticleExporter_JSON(this));
